...
export interface IBetSelection extends mongoose.Document {
    code: number;
    name: string;
    status: string;
    country: ICountry;
...
export const BetSelectionSchema = new mongoose.Schema({
...
const betselection = mongoose.model<IBetSelection>("betselections_v", BetSelectionSchema,"betselections_v");
