...
//import FavouriteScreen from './screens/FavouriteScreen';
import Success from './screens/success'; import Failure from './screens/failure';
import Login from './login';
...
const DashboardNavi = createStackNavigator(
  {
    ...
    AccountScreen: {
      ...
      navigationOptions: {
        ...
        headerTintColor: 'red',
        headerStyle: {
          backgroundColor: 'red', paddingTop: 30, borderBottomWidth: 0, borderColor: '#f3f6f8',
          borderWidth: 0,
          TextColor: '#fff',
          elevation: 0,
          shadowOpacity: 0,
...
//  headerLeft: <HeaderBackButton onPress={() => navigation.goBack(null)} />,
// headerStyle: {
//     backgroundColor: '#FFF',marginTop:30,paddingLeft:-10,
//     TextColor:'#000',
//     elevation: 0,     
//   shadowOpacity: 0, 
//   },
...
const premium = createStackNavigator({
  ...
  SubscribePhoneScreen: {
    ...
    navigationOptions: ({ navigation }) => ({
      ...
      headerStyle: {
        backgroundColor: '#000', paddingTop: 20, borderBottomWidth: 0, borderColor: '#f3f6f8',
        borderWidth: 0,
        elevation: 0,
        marginTop: 10,
        shadowOpacity: 0,
...
const SearchNavigator = createStackNavigator(
  {
    Search: {
      ...
      navigationOptions: {
        ...
        headerTintColor: 'white',
        headerStyle: {
          backgroundColor: '#fff', paddingTop: 30, borderBottomWidth: 0, borderColor: '#f3f6f8',
          borderWidth: 0,
          TextColor: '#fff',
          elevation: 0,
          shadowOpacity: 0,
...
const LoginNavigator = createStackNavigator(
  {
    ...
    OtpScreen: {
      screen: OtpScreen, navigationOptions: {
        title: 'Personal Details',
        headerStyle: {
          backgroundColor: '#f3f6f8', paddingTop: 20, borderBottomWidth: 0, borderColor: '#f3f6f8',
          borderWidth: 0,
          TextColor: '#000',
          elevation: 0,
          shadowOpacity: 0,
    ...
    login: { screen: Login, navigationOptions: { header: null, tabBarVisible: false, }, path: '/' },
    ...
    otpverfication: { screen: OtpVerification, navigationOptions: { header: null } },
    Home: {
      screen: HomeScreen,
      path: '/home',
      navigationOptions: ({ navigation }) => ({ //don't forget parentheses around the object notation
   ...
   marginTop:20
    ...
    Googlesigninlogin: {
      ...
      navigationOptions: {
        header: null, headerTintColor: 'black', headerStyle: {
          backgroundColor: 'red'
        }
      }
    },
    ...
    SplashScreen: {
      ...
      path: '/SplashScreen',
      navigationOptions: {
        header: null, tabBarVisible: false, headerTintColor: 'black', headerStyle: {
          backgroundColor: 'red'
        }
      }
    },
...
const TabbarStack = createBottomTabNavigator(
  {
    ...
    premium: {
      ...
      navigationOptions: {
        ...
        tabBarIcon: ({ tintColor }) => (
          <FontAwesome name="rupee" color={tintColor} size={25} />
        ),
  ...
  },
  {
    ...
    tabBarOptions: {
      ...
      style: {
        borderTopWidth: 0, backgroundColor: '#292929', height: 60, paddingBottom: 8, paddingTop: 10
      },
    },
  ...
  LoginNavigator.navigationOptions = ({ navigation }) => {
    ...
    /*let premiums=navigation.state.routes[navigation.state.index].params;
...
console.log(premiums);
    ...
    if (routeName == 'PlaylistScreen' || routeName == 'SplashScreen' || routeName == 'OtpScreen' || routeName == 'SubscribeScreen'
      || routeName == 'SubscribePhoneScreen' || routeName == 'Googlesigninlogin' || routeName == 'RegisterEmail') {
      tabBarVisible = false
    }
    // tabBarVisible = false
